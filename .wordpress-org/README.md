...
```
plugins/fluid-font-forge-svn/assets/
```
...
2. Sample text preview with viewport slider
3. Generated CSS output with copy-to-clipboard
4. Settings panel with scaling ratios
```
