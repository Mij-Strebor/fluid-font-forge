 ...
 */
define('FLUID_FONT_FORGE_VERSION', '5.3.0');
 ...
 * @since 1.0.0
 */
require_once FLUID_FONT_FORGE_PATH . 'includes/fff-import-export-init.php';
...
if (is_admin()) {
     ...
     */
    $fluid_font_forge = new \JimRForge\FluidFontForge\FluidFontForge();
}
