    ...
    <div class="fcc-panel" style="margin-bottom: 8px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px;">
            <div class="grid-item">
                ...
                <input type="number" id="min-root-size" value="<?php echo esc_attr($settings['minRootSize'] ?? FluidFontForge::DEFAULT_MIN_ROOT_SIZE); ?>"
                    class="component-input" style="width: 100%;"
                    min="<?php echo esc_attr(FluidFontForge::MIN_ROOT_SIZE_RANGE[0]); ?>"
                    max="<?php echo esc_attr(FluidFontForge::MIN_ROOT_SIZE_RANGE[1]); ?>"
                    step="1"
            ...
            <div class="grid-item">
                ...
                <input type="number" id="min-viewport" value="<?php echo esc_attr($settings['minViewport']); ?>"
                    class="component-input" style="width: 100%;"
                    min="<?php echo esc_attr(FluidFontForge::VIEWPORT_RANGE[0]); ?>"
                    max="<?php echo esc_attr(FluidFontForge::VIEWPORT_RANGE[1]); ?>"
                    step="1"
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px;">
            <div class="grid-item">
                ...
                <input type="number" id="max-root-size" value="<?php echo esc_attr($settings['maxRootSize'] ?? FluidFontForge::DEFAULT_MAX_ROOT_SIZE); ?>"
                    class="component-input" style="width: 100%;"
                    min="<?php echo esc_attr(FluidFontForge::MIN_ROOT_SIZE_RANGE[0]); ?>"
                    max="<?php echo esc_attr(FluidFontForge::MIN_ROOT_SIZE_RANGE[1]); ?>"
                    step="1"
