...
<div class="fff-info-toggle-section" style="clear: both; margin: 20px 0;">
    ...
    <button class="fff-info-toggle <?php echo esc_attr($fluid_font_forge_expanded_class); ?>" data-toggle-target="font-preview-content">
        <span style="color: var(--clr-textLight) !important;">Font Scale</span>
    ...
    <div class="fff-info-content <?php echo esc_attr($fluid_font_forge_expanded_class); ?>" id="font-preview-content">
        ...
        <div class="fff-preview-grid">
            <div class="fff-preview-column">
                ...
                <div id="preview-min-container" style="background: var(--clr-white); border-radius: var(--rad-large); padding: 20px; border: 2px solid var(--clr-secondary); min-height: 320px; box-shadow: inset 0 2px 4px var(--clr-shadow); max-height: 500px; overflow-y: auto;">
            ...
            <div class="fff-preview-column">
                ...
                <div id="preview-max-container" style="background: var(--clr-white); border-radius: var(--rad-large); padding: 20px; border: 2px solid var(--clr-secondary); min-height: 320px; box-shadow: inset 0 2px 4px var(--clr-shadow); max-height: 500px; overflow-y: auto;">
                    <div style="text-align: center; color: var(--clr-txt); font-style: italic; padding: 60px 20px;">
                        <div class="fff-loading-spinner" style="width: 25px; height: 25px; margin: 0 auto 10px;"></div>
                        <div>Loading preview...</div>
                    </div>
