...
<div style="margin: 2rem 0;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
        <div class="fff-font-input">
            ...
            <button type="button" id="reset-font-btn" class="fff-btn" style="margin-left: 8px; padding: 4px 12px; font-size: 12px;" data-tooltip="Clear custom font and return to default system fonts">reset</button>
        </div>
        ...
        <div style="display: flex; align-items: center; gap: 20px;">
            <div class="fff-autosave-flex">
                <label data-tooltip="Automatically save changes as you make them">
                    ...
                    <span>Autosave</span>
                </label><button id="save-btn" class="fff-btn" style="padding: 4px 12px; font-size: 12px;" data-tooltip="Save all current settings and sizes to database">
                    save
                </button>
