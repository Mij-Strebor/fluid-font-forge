...
<div class="fff-info-toggle-section">
    ...
    <div class="fff-info-content <?php echo esc_attr($fluid_font_forge_expanded_class); ?>" id="about-content">
        <div style="color: var(--clr-txt); font-size: 16px; line-height: 1.6; max-width: 100%; box-sizing: border-box;">
            ...
            <div style="background: rgba(60, 32, 23, 0.1); padding: 12px 16px; border-radius: 6px; border-left: 4px solid var(--clr-accent); margin-top: 20px; max-width: 100%; box-sizing: border-box;">
