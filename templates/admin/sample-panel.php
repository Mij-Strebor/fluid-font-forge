...
<div class="fcc-preview-enhanced" style="clear: both; margin: 20px 0;">
    ...
    margin-bottom: var(--jimr-space-5); cursor: pointer;">
        <span style="color: var(--clr-primary) !important; font-family: 'Inter', sans-serif !important; font-size: 24px !important; font-weight: 600 !important;">>📝 Sample Text</span>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; height: 100%; align-items: start;">
                ...
                <div style="overflow: hidden; background: rgba(59, 130, 246, 0.03); padding: 16px; border-radius: 6px;">
                    <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 12px;">
                        ...
                        <span id="titles-size-display" style="font-size: 16px; color: var(--clr-primary); font-weight: 600;">--</span>
                    </div>
                ...
                <div style="overflow: hidden; background: rgba(59, 130, 246, 0.03); padding: 16px; border-radius: 6px;">
                    <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 12px;">
                        ...
                        <span id="text-size-display" style="font-size: 16px; color: var(--clr-primary); font-weight: 600;">--</span>
                    </div>
