...
<div class="fff-info-toggle-section" style="margin-top: 20px;">
    ...
    <div class="fff-info-content expanded" id="sample-space-content">
        <div class="fff-sample-space-container">

            <!-- Sample Displays -->
            <div class="fff-sample-displays">

                <!-- Margin Sample -->
                <div class="fff-sample-group">
                    <div class="fff-sample-label">Margin Preview</div>
                    <div class="fff-sample-box-wrapper">
                        <div id="margin-sample" class="fff-margin-sample">
                            <div class="fff-sample-inner">Content</div>
                        </div>
                        <div class="fff-sample-value" id="margin-value">12px</div>
                    </div>
                </div>

                <!-- Padding Sample -->
                <div class="fff-sample-group">
                    <div class="fff-sample-label">Padding Preview</div>
                    <div class="fff-sample-box-wrapper">
                        <div id="padding-sample" class="fff-padding-sample">
                            <div class="fff-sample-inner">Content</div>
                        </div>
                        <div class="fff-sample-value" id="padding-value">12px</div>
                    </div>
                </div>

                <!-- Gap Sample -->
                <div class="fff-sample-group">
                    <div class="fff-sample-label">Gap Preview</div>
                    <div class="fff-sample-box-wrapper">
                        <div id="gap-sample" class="fff-gap-sample">
                            <div class="fff-sample-item">Item 1</div>
                            <div class="fff-sample-item">Item 2</div>
                        </div>
                        <div class="fff-sample-value" id="gap-value">12px</div>
                    </div>
                </div>
            </div>

            <!-- Controls Row -->
            <div class="fff-sample-controls">
                <div class="fff-sample-selector">
            ...
            <!-- Viewport Slider -->
            <div class="fff-viewport-slider-section">
                <div class="fff-viewport-info">
                ...
                <div class="fff-viewport-slider-container">
                    <input type="range"
